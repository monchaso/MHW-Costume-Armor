...
DialogWindow::DialogWindow(QWidget *parent, const QString &Title,
...
DialogWindow::~DialogWindow() { delete ui; }

QString getTextInputDialog(QWidget *parent, const QString &Title,
                           const QString &Message, bool *ok) {
  return QInputDialog::getText(parent, Title, Message, QLineEdit::Normal, "",
                               ok,
                               Qt::WindowTitleHint | Qt::WindowSystemMenuHint |
                                   Qt::WindowCloseButtonHint);
}

std::tuple<QString, uint, bool> getItemInputDialog(QWidget *parent,
                                                   const QString &title,
                                                   const QString &message,
                                                   const QStringList &items,
                                                   const QList<uint> &datas) {
  auto text = items.value(0);
  auto dialog =
      new QInputDialog(parent, Qt::WindowTitleHint | Qt::WindowSystemMenuHint |
                                   Qt::WindowCloseButtonHint);
